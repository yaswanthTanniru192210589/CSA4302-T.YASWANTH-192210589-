...
$stmt = $conn->prepare("INSERT INTO orders (name, email, address, phone, purpose, delivery_date, delivery_time, instructions, payment_method, cart_items, total_amount) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
